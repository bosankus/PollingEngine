...
class PollingEngineCoreTests {
    @Test
    fun successStopsWhenTerminalReached() =
        runTest {
            var calls = 0
            val config =
                PollingConfig(
    ...
    @Test
    fun nonRetryableFailureEndsAsExhausted() =
        runTest {
            val config =
                PollingConfig<Int>(
    ...
    @Test
    fun retriesUntilMaxAttemptsWhenRetryable() =
        runTest {
            var attempts = 0
            val config =
                PollingConfig<Int>(
    ...
    @Test
    fun overallTimeoutLeadsToTimeoutOutcome() =
        runTest {
            var calls = 0
            val config =
                PollingConfig(
    ...
    @Test
    fun composeStopsOnFirstNonSuccess() =
        runTest {
            val cfg1 =
                PollingConfig(
                    fetch = { Success(1) },
